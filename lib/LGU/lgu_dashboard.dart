                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        "LGU Admin",
                        style: TextStyle(fontSize: 20, color: Color.fromARGB(255, 0, 92, 118), fontWeight: FontWeight.bold),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: const Text("Hello, User!", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118))),
                              ),
                            ),
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                const Text("Reminders", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118))),
                                      ...
                                      child: Column(
                                        children: [
                                          _SummaryCard(
                                            ...
                                            color: Colors.white,
                                            valueColor: const Color.fromARGB(255, 0, 92, 118),
                                            labelColor: const Color(0xFF087693),
                                          ),
                                          const SizedBox(height: 12),
                                          _SummaryCard(
                                            label: 'Passed',
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            const Text("Water Refilling Stations\nIloilo City", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118))),
                                            const SizedBox(height: 12),
                                            const SizedBox(height: 8),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        leading: Icon(
          icon,
          color: selected ? const Color(0xFF087693) : Colors.grey, // changed unselected icon color to grey
        ),
        title: Text(
          label,
          style: TextStyle(
            color: selected ? const Color.fromARGB(255, 0, 92, 118) : Colors.grey, // changed unselected label color to grey
...
class _ReminderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: Color(0xFF087693)),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Text('Profile', style: TextStyle(color: Color.fromARGB(255, 0, 92, 118), fontWeight: FontWeight.bold, fontSize: 18)),
          ),
          const SizedBox(height: 18),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Column(
                children: [
                  const CircleAvatar(radius: 48, backgroundColor: Color(0xFFEAF6FF), child: Icon(Icons.person, size: 48, color: Color(0xFF087693))),
                  const SizedBox(height: 12),
                  Row(
                    children: const [
                      Icon(Icons.edit, color: Color(0xFF087693), size: 16),
                      SizedBox(width: 6),
                      Text('Change Profile Picture', style: TextStyle(color: Color.fromARGB(255, 0, 92, 118))),
                    ],
                  ),
                  const SizedBox(height: 18),
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {},
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFF0094c3),
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
                      ),
                      child: const Text('Save Changes', style: TextStyle(color: Color.fromARGB(255, 255, 255, 255)) ),
                    ),
                  ),
                ],
              ),
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const Spacer(),
              Icon(Icons.settings, color: Color(0xFF087693)),
              const SizedBox(width: 20),
              Icon(Icons.notifications_none, color: Color(0xFF087693)),
              const SizedBox(width: 20),
              Icon(Icons.person_outline, color: Color(0xFF087693)),
            ],
          ),
        ),
        // Table
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            icon: const Icon(Icons.edit, color: Color(0xFF087693)),
            onPressed: onEdit,
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(
          flex: 3,
          child: Text(label, style: const TextStyle(color: Color.fromARGB(255, 0, 92, 118))),
        ),
        const SizedBox(width: 8),
        Expanded(
          flex: 6,
