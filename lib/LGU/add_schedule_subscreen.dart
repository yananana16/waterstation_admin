    ...
    return ListView.separated(
      ...
      itemBuilder: (context, idx) {
        ...
        return ListTile(
          ...
          trailing: selected ? const Icon(Icons.check, color: Color(0xFF087693)) : null,
          onTap: () => setState(() {
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Text(label, style: TextStyle(fontWeight: FontWeight.w600, color: const Color.fromARGB(255, 0, 92, 118), fontSize: 14 * scale)),
          ),
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                IconButton(
                  icon: Icon(Icons.arrow_back, color: const Color(0xFF087693), size: 20 * scale),
                  onPressed: () {
                    if (widget.onClose != null) widget.onClose!();
                  },
                ),
                SizedBox(width: 8 * scale),
                Text('Add Schedule', style: TextStyle(color: const Color.fromARGB(255, 0, 92, 118), fontSize: 18 * scale, fontWeight: FontWeight.bold)),
                const Spacer(),
              ],
            ),
          ),
                  ...
                  children: [
                    ...
                    _fieldRow(
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 8 * scale),
                          IconButton(onPressed: _pickDate, icon: Icon(Icons.calendar_today, color: const Color(0xFF087693), size: 20 * scale)),
                        ],
                      ),
                      labelWidth,
                      scale,
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            padding: EdgeInsets.symmetric(vertical: 12 * scale, horizontal: 16 * scale),
                            color: const Color(0xFFF2F6FA),
                            child: Text('Search Stations', style: TextStyle(fontWeight: FontWeight.w600, color: const Color.fromARGB(255, 0, 92, 118), fontSize: 14 * scale)),
                          ),
                          SizedBox(width: 12 * scale),
                          Expanded(
                            child: TextField(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Stations', style: TextStyle(fontWeight: FontWeight.bold, color: const Color.fromARGB(255, 0, 92, 118))),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text('Show pending only', style: TextStyle(color: const Color.fromARGB(255, 0, 92, 118))),
                                    Switch(
                                      value: _showPendingOnly,
                                      activeTrackColor: const Color(0xFF087693),
                                      onChanged: (v) async {
