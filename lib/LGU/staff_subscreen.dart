                  ...
                  children: [
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(side: const BorderSide(color: Color(0xFF087693))),
                        child: const Text('Edit', style: TextStyle(color: Color.fromARGB(255, 255, 255, 255)), overflow: TextOverflow.ellipsis),
                      ),
                    ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 8),
                const Text('Staff', style: TextStyle(color: Color(0xFF087693), fontSize: 18, fontWeight: FontWeight.bold)),
                const Spacer(),
                ElevatedButton.icon(
                  onPressed: _showAddInspectorDialog,
                  icon: const Icon(Icons.person_add, color: Color.fromARGB(255, 255, 255, 255)),
                  label: const Text('Add Inspector', style: TextStyle(color: Color.fromARGB(255, 255, 255, 255), fontSize: 18, fontWeight: FontWeight.bold)),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: TextField(
                          decoration: InputDecoration(
                            ...
                            hintText: 'Search', hintStyle: TextStyle(color: Color(0xFF087693), fontSize: 18, fontWeight: FontWeight.bold),
                            filled: true,
                      ...
                      ElevatedButton(
                        onPressed: () {},
                        style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF087693)),
                        child: const Text('Filter', style: TextStyle(color: Color.fromARGB(255, 255, 255, 255), fontSize: 18, fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: const [
                                SizedBox(width: 140, child: Text('Inspector No.', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                Expanded(child: Text('First Name', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                Expanded(child: Text('Last Name', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                Expanded(child: Text('Phone Number', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                Expanded(child: Text('Email', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                SizedBox(width: 140, child: Text('Role', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                SizedBox(width: 120, child: Text('Actions', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                              ],
                            ),
                          ),
                          Expanded(
                                              ...
                                              children: [
                                                SizedBox(
                                                  ...
                                                  child: OutlinedButton(
                                                    ...
                                                    style: OutlinedButton.styleFrom(side: const BorderSide(color: Color(0xFF087693))),
                                                    child: const Text('Edit', style: TextStyle(color: Color.fromARGB(255, 0, 92, 118)), overflow: TextOverflow.ellipsis),
                                                  ),
                                                ),
                                                const SizedBox(width: 8),
                                                SizedBox(
