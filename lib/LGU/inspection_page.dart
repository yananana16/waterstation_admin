          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Text('Inspection', style: TextStyle(color: Color.fromARGB(255, 0, 92, 118), fontSize: 18, fontWeight: FontWeight.bold)),
                const Spacer(),
              ],
            ),
          ),
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: const [
                                SizedBox(width: 36, child: Text('No.', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                Expanded(child: Text('Station', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                Expanded(child: Text('Location', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                Expanded(child: Text('Date', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                Expanded(child: Text('Officer', style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                                SizedBox(width: 90, child: Text('Status', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 92, 118)))),
                              ],
                            ),
                          ),
                          // rows
                          if (paged.isEmpty)
                            ...
                            ...paged.map((row) => Container(
                                  decoration: const BoxDecoration(border: Border(top: BorderSide(color: Color(0xFF087693)))),
                        ...
                        Row(
                          children: [
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF0094c3)),
