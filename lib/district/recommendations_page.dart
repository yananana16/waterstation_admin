...
class RecommendationsPage extends StatelessWidget {
              ...
              if (buttonText.isNotEmpty)
                Align(
                  ...
                  child: TextButton(
                    ...
                    child: Text(buttonText, style: const TextStyle(color: Color(0xFF0D47A1), fontWeight: FontWeight.w600)),
                  ),
                ),
            ],
          ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(value, style: const TextStyle(fontSize: 18, color: Color(0xFF0D47A1), fontWeight: FontWeight.bold), maxLines: 2, overflow: TextOverflow.ellipsis),
                      if (subtitle != null) ...[
  ...
  Widget _ordersByAreaPlaceholder() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Orders by Area', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1))),
                  ...
                  child: Stack(
                    children: [
                      ...
                      FractionallySizedBox(
                        ...
                        child: Container(height: 14, decoration: BoxDecoration(color: const Color(0xFF2B6BE8), borderRadius: BorderRadius.circular(6))),
                      ),
                    ],
                  ),
                ),
  ...
  Widget _sparklinePlaceholder() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Order Trend', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1))),
        const SizedBox(height: 12),
        SizedBox(
          height: 140,
          child: CustomPaint(
      ...
      children: [
        Expanded(
          child: Column(
            ...
            children: [
              const Text('Station Location', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1))),
        ...
        SizedBox(
          ...
          child: Container(
            ...
            child: const Center(child: Icon(Icons.location_on, color: Color(0xFF2B6BE8), size: 36)),
          ),
        ),
      ],
    );
            ...
            children: [
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
                  Text('District Recommendations Dashboard', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1))),
                  SizedBox(height: 6),
                        ...
                        child: Column(
                          ...
                          children: [
                            Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
                              Text('Delivery Fee', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1))),
                              SizedBox(height: 8),
                    ...
                    child: ConstrainedBox(
                      ...
                      child: _largeCard(
                        child: Column(
                          ...
                          children: [
                            Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
                              Text('Statinform', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1))),
                              SizedBox(height: 8),
                ...
                children: [
                  ...
                  _largeCard(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      const Text('Delivery Fee', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1))),
                      const SizedBox(height: 8),
                  ...
                  _largeCard(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      const Text('Statinform', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1))),
                      const SizedBox(height: 8),
